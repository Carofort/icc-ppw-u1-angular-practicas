...
![Ejemplo de layout con flex-col-reverse en el localhost](src/assets/01-flex-col.png)
...
![Ejemplo de layout con grid gap-4 en el localhost](src/assets/02-grid-gap-4.png)
...
![Ejemplo de layout con row-span y col-span en el localhost](src/assets/03-grid-row.png)
...
![Ejemplo de layout con flex-wrap justify-center-safe en el localhost](src/assets/04-flex-justify.png)
...
![Ejemplo de layout con flex-col-reverse en el localhost](src/assets/practica5/05-a-errores.png)

![Ejemplo de layout con flex-col-reverse en el localhost](src/assets/practica5/05-a-validado.png)


#### Práctica B: Rutilización de código ```FormUtils```
![Ejemplo de layout con flex-col-reverse en el localhost](src/assets/practica5/05-b-errores.png)

![Ejemplo de layout con flex-col-reverse en el localhost](src/assets/practica5/05-b-validado.png)



#### Práctica C: Formularios complejos ```dinámicos + especiales```
![Ejemplo de layout con flex-col-reverse en el localhost](src/assets/practica5/05-c-errores.png)

![Ejemplo de layout con flex-col-reverse en el localhost](src/assets/practica5/05-c-validado.png)
